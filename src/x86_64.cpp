...
x86_64::InstructionData x86_64::encode_rm(x86_64::EncodingData data, x86_64::Reg rm) {
...
x86_64::InstructionData x86_64::encode_reg(x86_64::EncodingData data, x86_64::Reg reg) {
    x86_64::InstructionData insn;
...
x86_64::InstructionData x86_64::encode_ri(x86_64::EncodingData data, x86_64::Reg rm, x86_64::ImmediateValue imm) {
    x86_64::InstructionData insn;
    ...
    if(data.enc_operand_in_opcode) {
        data.enc_opcode[data.opcode_size - 1] |= ENCODE_REG(rm);
    }
    insn.set_opcode(data.enc_opcode, data.opcode_size);

    if(!data.enc_operand_in_opcode) {
        insn.set_modrm(3, 0, rm % 8);
    }
...
x86_64::InstructionData encode_mi(x86_64::EncodingData data, x86_64::AddressValue addr, x86_64::ImmediateValue imm) {
            ...
            if(IS_REG_8_BIT(r1)) {
                if(d.is_8_bit) {
                    if(d.direction == x86_64::OPERAND_DIRECTION_RM_IMM) {
                        return x86_64::encode_ri(d, r1, imm);
                    }
                }
            } else {
                if(!d.is_8_bit) {
